...
suite("VSCode-POVRay extension Tests", function () {
    ...
    test("buildShellPOVExe_win32_bash", function () {
        ...
        let settings = {
            ...
            libraryPath: "",
            displayImageDuringRender: false,
    ...
    test("getDisplayRenderOption_false", function () {
        let settings = {
            outputPath: "./output/",
            defaultRenderWidth: "1024",
            defaultRenderHeight: "768",
        ...
        let renderOption = povrayExtension.getDisplayRenderOption(settings);
        assert.equal(renderOption, " -D");
    });
    test("getDisplayRenderOption_true", function () {
        let settings = {
            outputPath: "./output/",
            defaultRenderWidth: "1024",
            defaultRenderHeight: "768",
            libraryPath: "/Users/myuser/Documents/POVRay/include/",
            displayImageDuringRender: true,
            openImageAfterRender: true,
            openImageAfterRenderInNewColumn: true,
            useDockerToRunPovray: false,
            useDockerImage: "jmaxwilson/povray",
